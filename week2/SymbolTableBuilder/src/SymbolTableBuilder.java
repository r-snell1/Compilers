...
public class SymbolTableBuilder {
    ...
    public static void main(String[] args) {
        if (args.length != 1) {
            System.out.println("Usage: java SymbolTableBuilder <path-to-java-source-file>");
            return;
        }// end if
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(fileName))) {
            ...
            System.out.println("Total Number of Identifiers (No reserved words): " + identifierCount);
            System.out.println("Total Number of Java Reserved Words: " + foundReservedWords.size());
